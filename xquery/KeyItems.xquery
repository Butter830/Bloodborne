...
<html>
   ...
   <div class="header"><h1>Bloodborne Item Finder</h1>
    ...
    <body>
            ...
            <table>
            <tr><i><b><font size="+2" color="white">Key Items</font></b></i><th></th>
             <p><u>{let $main := collection("../xml/")
        let $a := " Key"
        let $Item := $main//keyItem[.//itemName]
let $Items := $main//keyItem/itemName
let $Item-count := $Items => count()
        
               return (concat ("There are a total of ", $Item-count, $a," items that are necessary for Hunters to reach the end of the night."))  
            }</u></p>
