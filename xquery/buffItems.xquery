...
<h4><a href="index.html">Home</a></h4>
    ...
    <body>
            ...
            <table>
            <tr><i><b><font size="+2" color="white">Weapon Buff Items</font></b></i><th></th>
                          <p><u>{let $main := collection("../xml/")
        let $b := " Buffs"
        let $Item := $main//weaponBuffItem[.//itemName]
let $Items := $main//weaponBuffItem/itemName
let $Item-count := $Items => count()
        
               return (concat ("There are a only ", $Item-count, $b," that you can apply to your weapons in Bloodborne."))  
            }</u></p>
